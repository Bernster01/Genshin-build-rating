...
const Xilonen = {
    ...
    elementalSkill: {
        Skill: yohualsScratch,
        Level: 1
    },
    elementalBurst: {
        Skill: ocelotlicuePoint,
        Level: 1
    },
    passive1: {
        Type: "A1",
...
const AllCharacters = {
    ...
    index: ["Albedo", "Alhaitham", "Aloy", "Amber", "Arlecchino", "Ayaka", "Ayato", "Baizhu", "Barbara", "Beidou", "Bennett",
        ...
        "Traveler (Dendro)", "Traveler (Electro)", "Traveler (Geo)", "Traveler (Hydro)", "Venti", "Wanderer", "Wriothesley", "Xiangling", "Xianyun", "Xiao", "Xilonen", "Xingqiu",
