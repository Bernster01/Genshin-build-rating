...
function generateCharacterCard(character, score, supportingElement, role, resonances, createData, date) {
    ...
    let supportingElementHtmlCode = (supportingElement != null && supportingElement != "noElement") ? `<img src="./Elements/${supportingElement.toLowerCase()}.png" alt="${supportingElement}">` : "<span>No on field element</span>";
    if (!createData) {
